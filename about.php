...
<body>
	<div class="header">
		<div class="header_top">
			<div class="wrap">
			 <div class="logo">
						<a href="index.php"><img src="images/91.png" alt="" /></a>
					</div>
			    <div class="call">
			    	<p><img src="images/45.png" alt="" />Call US: +91869877087</p>
			    </div>
      			...
      			<div class="company_address">
				     	<h2>Company Information :</h2>
						    	<p>Milano Salon,</p>
						   		<p>Mumbai</p>
						   		<p>Maharashtra</p>
				   			<p>Phone: +91869877087</p>
				 	 		<p>Email: <span>milano@gmail.com</span></p>
				   			<p>Follow on: <span>Instagram</span>, <span>Twitter</span></p>
				 </div>
			  </div>			
       </div>
    </div>
					...
					<h3>Get In Touch</h3>
							...
							<ul>
						  	 <li>Milano Salon,</li>
						  	  <li>Mumbai,</li>
						  	   <li>Maharashtra.</li>
						  	 <li>www.milano@gmail.com</li>
						  	 <li><span>Phone :</span> +91869877087 </li>
						  </ul>
				   </div>				  
			     </div>
